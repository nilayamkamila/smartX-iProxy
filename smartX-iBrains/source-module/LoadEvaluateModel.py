...
df = read_csv("../data-module/ExperienceSalaryProxyForward_Data.csv")
...
dump(mind ,"../model-module/ExperienceForwardToModel.pkl")
...
# Trained the Machine Learning Model using X_train, y_train data
mind.fit(X_train ,z_train)

# Saving the Model as pickle file
dump(mind ,"../model-module/ExperienceSalaryModel.pkl")